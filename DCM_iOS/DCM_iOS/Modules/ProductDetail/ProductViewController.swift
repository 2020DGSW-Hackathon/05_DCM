...
class ProductViewController: BaseViewController, StoryboardSceneBased {
    ...
    override func bindViewModel() {
        ...
        output.item.bind(to: tableView.rx.items(cellIdentifier: "ProductDetailCell", cellType: ProductDetailTableViewCell.self)) { (index: Int, element: ProductModel, cell: ProductDetailTableViewCell) in
